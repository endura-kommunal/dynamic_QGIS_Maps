...
### Variablen ###
# Seitengrößen
custom_page_size_width = 297  # mm
custom_page_size_height_vquu = 210  # mm
# Abstände zur Seite
custom_page_dist_left_vquu = 3
custom_page_dist_right_vquu = 3
custom_page_dist_top_vquu = 3
custom_page_dist_bottom_vquu = 3
# Abstände von Elementen zum Rahmen
custom_item_dist_left_vquu = 3
custom_item_dist_right_vquu = 3
custom_item_dist_top_vquu = 3
custom_item_dist_bottom_vquu = 3
# Liniendicke des Rahmens
custom_frame_line_width_vquu = 0.3
# Abstand zwischen Titel und Text
custom_dist_title_text_vquu = 2
# Breite der Rahmen
custom_frame_width_vquu = 60
# Größe Nordpfeil
custom_north_arrow_width_vquu = 9
custom_north_arrow_height_vquu = 15
# Größe Logos
custom_endura_logo_width_vquu = 13
# Font
font = "Calibri"
font_size = 10
font_size_title = 10
...
custom_scale_label_space_vquu = 2
custom_scale_bar_height_vquu = 2
# Pfade
...
custom_variables = {
        "custom_page_dist_left_vquu": str(custom_page_dist_left_vquu),
        "custom_page_dist_right_vquu": str(custom_page_dist_right_vquu),
        "custom_page_dist_top_vquu": str(custom_page_dist_top_vquu),
        "custom_page_dist_bottom_vquu": str(custom_page_dist_bottom_vquu),
        "custom_item_dist_left_vquu": str(custom_item_dist_left_vquu),
        "custom_item_dist_right_vquu": str(custom_item_dist_right_vquu),
        "custom_item_dist_top_vquu": str(custom_item_dist_top_vquu),
        "custom_item_dist_bottom_vquu": str(custom_item_dist_bottom_vquu),
        "custom_frame_line_width_vquu": str(custom_frame_line_width_vquu),
        "custom_dist_title_text_vquu": str(custom_dist_title_text_vquu),
        "custom_frame_width_vquu": str(custom_frame_width_vquu),
        "custom_north_arrow_width_vquu": str(custom_north_arrow_width_vquu),
        "custom_north_arrow_height_vquu": str(custom_north_arrow_height_vquu),
        "custom_scale_label_space_vquu": str(custom_scale_label_space_vquu),
        "custom_scale_bar_height_vquu": str(custom_scale_bar_height_vquu),
        "custom_page_size_width_vquu": str(custom_page_size_width),
        "custom_page_size_height_vquu": str(custom_page_size_height_vquu),
        "custom_font_size_vquu": str(font_size),
        "custom_font_size_title_vquu": str(font_size_title),
        "custom_font_size_metadata_vquu": str(font_size_metadata),
        "custom_font_family_vquu": font,
        "custom_endura_logo_width_vquu": str(custom_endura_logo_width_vquu),
    }
...
layout_name = "Vollbildkarte_quer_Uebersicht_untenrechts"
...
page.dataDefinedProperties().setProperty(
    QgsLayoutItemPage.ItemWidth, QgsProperty.fromExpression(
        "@custom_page_size_width_vquu"
    )
)
page.dataDefinedProperties().setProperty(
    QgsLayoutItemPage.ItemHeight, QgsProperty.fromExpression(
        "@custom_page_size_height_vquu"
    )
)
...
map.setFrameStrokeWidth(QgsLayoutMeasurement(custom_frame_line_width_vquu))
map.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionX,
    QgsProperty.fromExpression("@custom_frame_line_width_vquu/2 + @custom_page_dist_left_vquu"),
)
map.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionY,
    QgsProperty.fromExpression("@custom_frame_line_width_vquu/2 + @custom_page_dist_top_vquu"),
)
map.dataDefinedProperties().setProperty(
    QgsLayoutObject.ItemWidth,
    QgsProperty.fromExpression(
        "(GetDynamicItemPositionX(@layout_name, 'legend_frame') - @custom_page_dist_left_vquu - @custom_frame_line_width_vquu) - GetDynamicItemPositionX(@layout_name, 'map')"
    ),
)
map.dataDefinedProperties().setProperty(
    QgsLayoutObject.ItemHeight,
    QgsProperty.fromExpression(
        "@custom_page_size_height_vquu - @custom_frame_line_width_vquu - @custom_page_dist_top_vquu - @custom_page_dist_bottom_vquu"
    ),
)
...
### Map Overview ###
map_overview = QgsLayoutItemMap(new_layout)
map_overview.setId("map_overview")
map_overview.setFrameEnabled(False)
map_overview.setFrameStrokeWidth(QgsLayoutMeasurement(custom_frame_line_width_vquu))
map_overview.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionX, QgsProperty.fromExpression("GetDynamicItemPositionX(@layout_name ,'legend_frame')")
)
map_overview.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionY, QgsProperty.fromExpression("@custom_page_size_height_vquu - @custom_frame_line_width_vquu / 2 - @custom_page_dist_bottom_vquu - GetDynamicItemHeight(@layout_name,'map_overview')")
)
map_overview.dataDefinedProperties().setProperty(
    QgsLayoutObject.ItemWidth,
    QgsProperty.fromExpression("@custom_frame_width_vquu"),
)
map_overview.dataDefinedProperties().setProperty(
    QgsLayoutObject.ItemHeight,
    QgsProperty.fromExpression("@custom_frame_width_vquu * 0.66"),
)

overview = map_overview.overview()
overview.setLinkedMap(map)  # 'map' is your main map item
overview.setFrameSymbol(
    QgsFillSymbol.createSimple(
        {
            "color": "227, 26, 28, 47",
            "outline_color": "157, 35, 35, 247",
            "outline_width": "0.16",
        }
    )
)
# map_overview.setOverview(overview)


canvas_extent = canvas_extent.buffered(canvas_extent.width() * 0.5)
map_overview.setExtent(canvas_extent)

new_layout.addLayoutItem(map_overview)


### overview map frame ###

map_frame_overview = QgsLayoutItemShape(new_layout)
map_frame_overview.setShapeType(QgsLayoutItemShape.Rectangle)
map_frame_overview.setId("map_frame_overview")

symbol = map_frame_overview.symbol()
layer = symbol.symbolLayer(0)
layer.setFillColor(Qt.transparent)
layer.dataDefinedProperties().setProperty(
    QgsSymbolLayer.PropertyStrokeWidth,
...
map_frame_overview.setSymbol(symbol)

map_frame_overview.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionX,
    QgsProperty.fromExpression(
        "GetDynamicItemPositionX(@layout_name,'map_overview')"
    )
)
...
map_frame_overview.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionY,
    QgsProperty.fromExpression(
        "GetDynamicItemPositionY(@layout_name,'map_overview')"
    )
)
...
map_frame_overview.dataDefinedProperties().setProperty(
    QgsLayoutObject.ItemWidth,
    QgsProperty.fromExpression(
        "GetDynamicItemWidth(@layout_name,'map_overview')"
    )
)
...
map_frame_overview.dataDefinedProperties().setProperty(
    QgsLayoutObject.ItemHeight,
    QgsProperty.fromExpression(
        "GetDynamicItemHeight(@layout_name,'map_overview')"
    )
)

new_layout.addLayoutItem(map_frame_overview)
...
legend_frame.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionX,
    QgsProperty.fromExpression(
        "@custom_page_size_width_vquu - @custom_page_dist_left_vquu - @custom_frame_width_vquu - @custom_frame_line_width_vquu"
    ),
)
legend_frame.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionY,
...
legend_frame.dataDefinedProperties().setProperty(
    QgsLayoutObject.ItemWidth, QgsProperty.fromExpression("@custom_frame_width_vquu")
)
...
legend_title.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionX,
    QgsProperty.fromExpression(
        "GetDynamicItemPositionX(  @layout_name ,'legend_frame') + (to_real(@custom_frame_line_width_vquu)/2) + to_real(@custom_item_dist_left_vquu)"
    ),
)
legend_title.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionY,
    QgsProperty.fromExpression(
        "GetDynamicItemPositionY(  @layout_name ,'legend_frame') + "
        "@custom_frame_line_width_vquu/2 + "
        "@custom_item_dist_top_vquu"
    ),
)
legend_title.dataDefinedProperties().setProperty(
    QgsLayoutObject.ItemWidth,
    QgsProperty.fromExpression(
        "to_real(@custom_frame_width_vquu) - "
        "2*to_real(@custom_frame_line_width_vquu) - "
        "to_real(@custom_item_dist_right_vquu) - "
        "to_real(@custom_item_dist_left_vquu)"
    ),
)
legend_title.setTextFormat(
    create_text_format(font, "custom_font_size_title_vquu", bold=True)
)
...
expr_legend_posX = "GetDynamicItemPositionX(  @layout_name ,'legend_frame') + (to_real(@custom_frame_line_width_vquu)/2) + to_real(@custom_item_dist_left_vquu)"
...
expr_legend_posY = (
    "GetDynamicItemPositionY(  @layout_name ,'legend_frame') + "
    "to_real(@custom_frame_line_width_vquu)/2 + "
    "to_real(@custom_item_dist_top_vquu) + "
    "GetDynamicItemHeight(@layout_name,'legend_title') + "
    "to_real(@custom_dist_title_text_vquu)"
)
legend.dataDefinedProperties().setProperty(
...
project_title.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionX,
    QgsProperty.fromExpression(
        "GetDynamicItemPositionX(  @layout_name ,'project_frame') + (to_real(@custom_frame_line_width_vquu)/2) + to_real(@custom_item_dist_left_vquu)"
    ),
)
project_title.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionY,
...
project_content.setTextFormat(
    create_text_format(font, "custom_font_size_text_vquu")
)
...
plan_content_title.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionX,
    QgsProperty.fromExpression(
        "GetDynamicItemPositionX(  @layout_name ,'plan_content_frame') + (to_real(@custom_frame_line_width_vquu)/2) + to_real(@custom_item_dist_left_vquu)"
    ),
)
plan_content_title.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionY,
...
plan_content.setTextFormat(create_text_format(font, "custom_font_size_vquu"))
...
metadata.setTextFormat(create_text_format(font, "custom_font_size_metadata_vquu"))
metadata.setMargin(0)
metadata.setId("metadata")
metadata.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionX,
    QgsProperty.fromExpression(
        "GetDynamicItemPositionX(  @layout_name ,'metadata_frame') + @custom_frame_line_width_vquu/2 + @custom_item_dist_left_vquu"
    ),
)
metadata.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionY,
...
north_arrow.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionX,
    QgsProperty.fromExpression(
        "(GetDynamicItemWidth(@layout_name, 'map') + @custom_page_dist_left_vquu) - @custom_item_dist_right_vquu - @custom_north_arrow_width_vquu"
    ),
)
north_arrow.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionY,
    QgsProperty.fromExpression(
        "GetDynamicItemPositionY(@layout_name, 'map') + @custom_item_dist_top_vquu + @custom_frame_line_width_vquu/2"
    ),
)
north_arrow.dataDefinedProperties().setProperty(
    QgsLayoutObject.ItemWidth, QgsProperty.fromExpression("@custom_north_arrow_width_vquu")
)
north_arrow.dataDefinedProperties().setProperty(
    QgsLayoutObject.ItemHeight, QgsProperty.fromExpression("@custom_north_arrow_height_vquu")
)
...
scale_bar.setTextFormat(create_text_format(font, "custom_font_size_metadata_vquu"))
scale_bar.setLabelBarSpace(custom_scale_label_space_vquu)
scale_bar.setLinkedMap(map)
scale_bar.dataDefinedProperties().setProperty(
    QgsLayoutObject.ScalebarHeight,
    QgsProperty.fromExpression(
        "@custom_scale_bar_height_vquu"
    )
)
...
scale_bar.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionX,
    QgsProperty.fromExpression(
        "GetDynamicItemPositionX(@layout_name, 'map') + @custom_frame_line_width_vquu/2 + @custom_item_dist_left_vquu - 0.4"
    ),
)
scale_bar.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionY,
    QgsProperty.fromExpression(
        "(GetDynamicItemPositionY(@layout_name, 'map') + GetDynamicItemHeight(@layout_name, 'map')) - to_real(@custom_item_dist_bottom_vquu) + 0.55"
    ),
)
scale_bar.dataDefinedProperties().setProperty(
    QgsLayoutObject.ItemHeight,
...
expr_endura_frame_height = "@custom_frame_line_width_vquu + if((GetDynamicItemHeight(@layout_name, 'endura_logo') + 1.776) > GetDynamicItemHeight(@layout_name, 'endura_content'), (GetDynamicItemHeight(@layout_name, 'endura_logo') + 1.776), GetDynamicItemHeight(@layout_name, 'endura_content')) + @custom_item_dist_top_vquu + @custom_item_dist_bottom_vquu + GetDynamicItemHeight(@layout_name, 'endura_title') + @custom_dist_title_text_vquu"
endura_frame.dataDefinedProperties().setProperty(
    QgsLayoutObject.ItemHeight,
...
endura_title.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionX,
    QgsProperty.fromExpression(
        "GetDynamicItemPositionX(  @layout_name ,'endura_frame') + (to_real(@custom_frame_line_width_vquu)/2) + to_real(@custom_item_dist_left_vquu)"
    ),
)
endura_title.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionY,
...
endura_logo.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionX,
    QgsProperty.fromExpression(
        "GetDynamicItemPositionX(@layout_name, 'endura_frame') + (to_real(@custom_frame_line_width_vquu)/2) + to_real(@custom_item_dist_left_vquu) + 0.2"
    ),
)
endura_logo.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionY,
    QgsProperty.fromExpression(
        "GetDynamicItemPositionY(@layout_name, 'endura_frame') + @custom_frame_line_width_vquu/2 + @custom_item_dist_top_vquu + GetDynamicItemHeight(@layout_name, 'endura_title') + @custom_dist_title_text_vquu + 1.776"
    ),
)
endura_logo.dataDefinedProperties().setProperty(
...
endura_content.setTextFormat(
    create_text_format(font, "custom_font_size_content_vquu")
)
...
endura_content.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionX,
    QgsProperty.fromExpression(
        "GetDynamicItemPositionX(@layout_name, 'endura_logo') + to_real(@custom_item_dist_left_vquu) + GetDynamicItemWidth(@layout_name, 'endura_logo')"
    ),
)
endura_content.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionY,
    QgsProperty.fromExpression(
        "GetDynamicItemPositionY(@layout_name, 'endura_frame') + @custom_frame_line_width_vquu/2 + @custom_item_dist_top_vquu + GetDynamicItemHeight(@layout_name, 'endura_title') + @custom_dist_title_text_vquu"
    ),
)
endura_content.dataDefinedProperties().setProperty(
    QgsLayoutObject.ItemWidth,
    QgsProperty.fromExpression(
        "(GetDynamicItemPositionX(@layout_name, 'endura_frame') + @custom_frame_width_vquu - @custom_item_dist_right_vquu) - GetDynamicItemPositionX(@layout_name, 'endura_content')"
    ),
)
endura_content.dataDefinedProperties().setProperty(
    QgsLayoutObject.ItemHeight,
...
expr_municipality_frame_height = "@custom_frame_line_width_vquu + if((GetDynamicItemHeight(@layout_name, 'municipality_logo')) > GetDynamicItemHeight(@layout_name, 'municipality_content'), (GetDynamicItemHeight(@layout_name, 'municipality_logo')), GetDynamicItemHeight(@layout_name, 'municipality_content')) + @custom_item_dist_top_vquu + @custom_item_dist_bottom_vquu + GetDynamicItemHeight(@layout_name, 'municipality_title') + @custom_dist_title_text_vquu"
municipality_frame.dataDefinedProperties().setProperty(
    QgsLayoutObject.ItemHeight,
...
municipality_title.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionX,
    QgsProperty.fromExpression(
        "GetDynamicItemPositionX(  @layout_name ,'municipality_frame') + (to_real(@custom_frame_line_width_vquu)/2) + to_real(@custom_item_dist_left_vquu)"
    ),
)
municipality_title.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionY,
...
municipality_logo.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionX,
    QgsProperty.fromExpression(
        "GetDynamicItemPositionX(@layout_name, 'municipality_frame') + (to_real(@custom_frame_line_width_vquu)/2) + to_real(@custom_item_dist_left_vquu) + 0.035"
    ),
)
municipality_logo.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionY,
    QgsProperty.fromExpression(
        "GetDynamicItemPositionY(@layout_name, 'municipality_frame') + @custom_frame_line_width_vquu/2 + @custom_item_dist_top_vquu + GetDynamicItemHeight(@layout_name, 'municipality_title') + @custom_dist_title_text_vquu"
    ),
)
municipality_logo.dataDefinedProperties().setProperty(
    QgsLayoutObject.ItemWidth, QgsProperty.fromExpression("@custom_endura_logo_width_vquu")
...
municipality_content.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionX,
    QgsProperty.fromExpression(
        "GetDynamicItemPositionX(@layout_name, 'municipality_logo') + to_real(@custom_item_dist_left_vquu) + GetDynamicItemWidth(@layout_name, 'municipality_logo')"
    ),
)
municipality_content.dataDefinedProperties().setProperty(
    QgsLayoutObject.PositionY,
...
municipality_content.dataDefinedProperties().setProperty(
    QgsLayoutObject.ItemWidth,
    QgsProperty.fromExpression(
        "(GetDynamicItemPositionX(@layout_name, 'municipality_frame') + @custom_frame_width_vquu - @custom_item_dist_right_vquu) - GetDynamicItemPositionX(@layout_name, 'municipality_content')"
    ),
)
municipality_content.dataDefinedProperties().setProperty(
    QgsLayoutObject.ItemHeight,
...
map_overview.refreshDataDefinedProperty(QgsLayoutObject.PositionX)
map_overview.refreshDataDefinedProperty(QgsLayoutObject.PositionY)
map_overview.refreshDataDefinedProperty(QgsLayoutObject.ItemWidth)
map_overview.refreshDataDefinedProperty(QgsLayoutObject.ItemHeight)

map.refresh()
map_overview.refresh()
